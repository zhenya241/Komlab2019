...
gTexts = [];
  ...
  .attr('class', 'cluster')
  .attr("points", "380,35 250,30 80,100 0,160 100,450 400,450 800,450 1150,200")
  .style("fill", "white")
  .style('opacity', '0.6')
  .style("stroke", "black")
 ...
 .attr('text-anchor', 'middle')
  ...
  .append('xhtml:div')
  .attr('class','button')
  .html('<a href="http://localhost:4200/object/modify5" class="btn btn-primary btn-sm btn-block" role="button" aria-pressed="true">Modify</a>');
  ...
  .append('xhtml:div')
  .attr('class','button')
  .html('<a href="http://localhost:4200/object/test5" class="btn btn-primary btn-sm btn-block" role="button" aria-pressed="true">Block Test</a>');
  ...
  .append('xhtml:div')
  .attr('class','button')
  .html('<a href="http://localhost:4200/object/singlechoicetest5" class="btn btn-primary btn-sm btn-block" role="button" aria-pressed="true">Choice Test</a>');
