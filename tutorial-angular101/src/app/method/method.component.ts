...
gTexts = [];
 ...
 .attr('text-anchor', 'middle')
  ...
  .append('xhtml:div')
  .attr('class','button')
  .html('<a href="http://localhost:4200/method/modify7" class="btn btn-primary btn-sm btn-block" role="button" aria-pressed="true">Modify</a>');
  ...
  .append('xhtml:div')
  .attr('class','button')
  .html('<a href="http://localhost:4200/method/test7" class="btn btn-primary btn-sm btn-block" role="button" aria-pressed="true">Block Test</a>');
  ...
  .append('xhtml:div')
  .attr('class','button')
  .html('<a href="http://localhost:4200/method/singlechoicetest7" class="btn btn-primary btn-sm btn-block" role="button" aria-pressed="true">Choice Test</a>');
