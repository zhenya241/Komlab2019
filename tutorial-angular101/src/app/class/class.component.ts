...
gTexts = [];
 ...
 .text('activate cluster')
  ...
  .append('xhtml:div')
  .attr('class','button')
  .html('<a href="http://localhost:4200/class/modify6" class="btn btn-primary btn-sm btn-block" role="button" aria-pressed="true">Modify</a>');
  ...
  .append('xhtml:div')
  .attr('class','button')
  .html('<a href="http://localhost:4200/class/test6" class="btn btn-primary btn-sm btn-block" role="button" aria-pressed="true">Block Test</a>');
  ...
  .append('xhtml:div')
  .attr('class','button')
  .html('<a href="http://localhost:4200/class/singlechoicetest6" class="btn btn-primary btn-sm btn-block" role="button" aria-pressed="true">Choice Test</a>');
