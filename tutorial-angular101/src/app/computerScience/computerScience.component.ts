...
gTexts = [];
 ...
 .attr('text-anchor', 'middle')
  ...
  var button = this.svg.append("foreignObject")
    ...
    .append('xhtml:div')
    .attr('class','button')
    .html('<a href="http://localhost:4200/computerScience/modify1" class="btn btn-primary btn-sm  btn-block" role="button" >Modify</a>');
    ...
    .append('xhtml:div')
    .attr('class','button')
    .html('<a href="http://localhost:4200/computerScience/test1" class="btn btn-primary btn-sm btn-block" role="button" >Block Test</a>');
    ...
    .append('xhtml:div')
    .attr('class','button')
    .html('<a href="http://localhost:4200/computerScience/singlechoicetest1" class="btn btn-primary btn-sm btn-block" role="button">Choice Test</a>');
