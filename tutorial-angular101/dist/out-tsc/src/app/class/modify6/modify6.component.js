...
var Modify6Component = /** @class */ (function () {
    function Modify6Component(modifyMapService, router) {
    ...
    Modify6Component.prototype.ngOnInit = function () {
    ...
    Modify6Component.prototype.ngAfterContentInit = function () {
    ...
    Modify6Component.prototype.mousedown = function (dataItem, value, source) {
    ...
    Modify6Component.prototype.mouseup = function (source) {
        // when mouseup, set the svg background as inactive
        this.svg.classed('active', false);
        this.svg.attr('clickOnNode', 'false');
    };
    Modify6Component.prototype.delayNavigation = function () {
        this.router.navigate([this.routerLink]);
    };
    // refresh function
    Modify6Component.prototype.restart = function () {
        // console.log('restart');
        var _this = this;
        var offset = 0;
    ...
    ], Modify6Component.prototype, "pdfViewers", void 0);
    Modify6Component = __decorate([
        Component({
    ...
    return Modify6Component;
}());
export { Modify6Component };
//# sourceMappingURL=modify6.component.js.map