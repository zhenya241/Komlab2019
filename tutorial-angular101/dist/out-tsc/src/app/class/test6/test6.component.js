...
var Test6Component = /** @class */ (function () {
    function Test6Component(testMapService, router) {
    ...
    Test6Component.prototype.ngOnInit = function () {
    ...
    Test6Component.prototype.ngAfterContentInit = function () {
        var _this = this;
    ...
    Test6Component.prototype.mousedown = function (dataItem, value, source) {
        // when mouse down set this.svg as active
        this.svg.classed('active', true);
        this.restart();
    };
    Test6Component.prototype.mouseup = function (source) {
        console.log('mouseup');
        this.svg.classed('active', false);
    };
    Test6Component.prototype.submitAnswer = function () {
        var resultAnswer = {};
        for (var i = 0; i < this.randomItem.length; i++) {
    ...
    Test6Component.prototype.delayNavigation = function () {
        this.router.navigate([this.routerLink]);
    };
    // refresh function
    Test6Component.prototype.restart = function () {
        var _this = this;
        var offset = 0;
...
export { Test6Component };
//# sourceMappingURL=test6.component.js.map