...
var Test7Component = /** @class */ (function () {
    function Test7Component(testMapService, router) {
    ...
    Test7Component.prototype.ngOnInit = function () {
    ...
    Test7Component.prototype.ngAfterContentInit = function () {
        var _this = this;
    ...
    Test7Component.prototype.mousedown = function (dataItem, value, source) {
        // when mouse down set this.svg as active
        this.svg.classed('active', true);
        this.restart();
    };
    Test7Component.prototype.mouseup = function (source) {
        console.log('mouseup');
        this.svg.classed('active', false);
    };
    Test7Component.prototype.submitAnswer = function () {
        var resultAnswer = {};
        for (var i = 0; i < this.randomItem.length; i++) {
    ...
    Test7Component.prototype.delayNavigation = function () {
        this.router.navigate([this.routerLink]);
    };
    // refresh function
    Test7Component.prototype.restart = function () {
        var _this = this;
        var offset = 0;
...
export { Test7Component };
//# sourceMappingURL=test7.component.js.map