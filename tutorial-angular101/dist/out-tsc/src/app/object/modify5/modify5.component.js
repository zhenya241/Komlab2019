...
var Modify5Component = /** @class */ (function () {
    function Modify5Component(modifyMapService, router) {
    ...
    Modify5Component.prototype.ngOnInit = function () {
        // console.log(json.nodes);
        this.nodes = json.nodes5;
        this.nodesNextMap = json.nodesNextMap5;
        this.linkwords = json.linkwords5;
        var temp = json.links5;
        // console.log(temp);
    ...
    Modify5Component.prototype.ngAfterContentInit = function () {
    ...
    Modify5Component.prototype.mousedown = function (dataItem, value, source) {
    ...
    Modify5Component.prototype.mouseup = function (source) {
        // when mouseup, set the svg background as inactive
        this.svg.classed('active', false);
        this.svg.attr('clickOnNode', 'false');
    };
    Modify5Component.prototype.delayNavigation = function () {
        this.router.navigate([this.routerLink]);
    };
    // refresh function
    Modify5Component.prototype.restart = function () {
        // console.log('restart');
        var _this = this;
        var offset = 0;
        ...
        else if (this.routerLink === '/variable') {
            this.svg.selectAll('ellipse').transition()
                .duration(750)
        ...
        else if (this.routerLink === '/primitiveType') {
            this.svg.selectAll('ellipse').transition()
                .duration(750)
    ...
    ], Modify5Component.prototype, "pdfViewers", void 0);
    Modify5Component = __decorate([
        Component({
            selector: 'app-modify5',
            templateUrl: './modify5.component.html',
            styleUrls: ['./modify5.component.css'],
            providers: [ModifyMapService],
        }),
        __metadata("design:paramtypes", [ModifyMapService, Router])
    ], Modify5Component);
    return Modify5Component;
}());
export { Modify5Component };
//# sourceMappingURL=modify5.component.js.map