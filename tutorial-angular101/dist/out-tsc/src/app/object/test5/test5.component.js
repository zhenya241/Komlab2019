...
var Test5Component = /** @class */ (function () {
    function Test5Component(testMapService, router) {
    ...
    Test5Component.prototype.ngOnInit = function () {
    ...
    Test5Component.prototype.ngAfterContentInit = function () {
        var _this = this;
    ...
    Test5Component.prototype.mousedown = function (dataItem, value, source) {
        // when mouse down set this.svg as active
        this.svg.classed('active', true);
        this.restart();
    };
    Test5Component.prototype.mouseup = function (source) {
        console.log('mouseup');
        this.svg.classed('active', false);
    };
    Test5Component.prototype.submitAnswer = function () {
        var resultAnswer = {};
        for (var i = 0; i < this.randomItem.length; i++) {
    ...
    Test5Component.prototype.delayNavigation = function () {
        this.router.navigate([this.routerLink]);
    };
    // refresh function
    Test5Component.prototype.restart = function () {
        var _this = this;
        var offset = 0;
...
export { Test5Component };
//# sourceMappingURL=test5.component.js.map