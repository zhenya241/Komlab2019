...
var Modify4Component = /** @class */ (function () {
    function Modify4Component(modifyMapService, router) {
    ...
    Modify4Component.prototype.ngOnInit = function () {
    ...
    Modify4Component.prototype.ngAfterContentInit = function () {
    ...
    Modify4Component.prototype.mousedown = function (dataItem, value, source) {
    ...
    Modify4Component.prototype.mouseup = function (source) {
        // when mouseup, set the svg background as inactive
        this.svg.classed('active', false);
        this.svg.attr('clickOnNode', 'false');
    };
    Modify4Component.prototype.delayNavigation = function () {
        this.router.navigate([this.routerLink]);
    };
    // refresh function
    Modify4Component.prototype.restart = function () {
        // console.log('restart');
        var _this = this;
        var offset = 0;
    ...
    ], Modify4Component.prototype, "pdfViewers", void 0);
    Modify4Component = __decorate([
        Component({
            selector: 'app-modify4',
            templateUrl: './modify4.component.html',
            styleUrls: ['./modify4.component.css'],
            providers: [ModifyMapService],
        }),
        __metadata("design:paramtypes", [ModifyMapService, Router])
    ], Modify4Component);
    return Modify4Component;
}());
export { Modify4Component };
//# sourceMappingURL=modify4.component.js.map